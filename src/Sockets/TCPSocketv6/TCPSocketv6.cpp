...
XPlatform::Api::XPResult XPlatform::Net::TCPSocketv6::Listen(const XPlatform::Net::g_IPEndPoint& EndPoint){
...
XPlatform::Api::XPResult XPlatform::Net::TCPSocketv6::Connect
...
uint32_t XPlatform::Net::TCPSocketv6::Select(uint32_t msecs){
	struct timeval tval;
